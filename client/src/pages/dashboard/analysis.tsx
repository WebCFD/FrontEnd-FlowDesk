  ...
  const handlePrint = useCallback(() => {
    ...
    w.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8">
      ...
      <style>
        ...
        .zone-figure{margin:0;text-align:center}
        .zone-figure img{max-width:560px;width:100%;border-radius:6px;box-shadow:0 1px 4px rgba(0,0,0,.12)}
        .zone-figure figcaption{font-size:10px;color:#94a3b8;margin-top:4px}
      ...
      <div class="zone-section">
        <h2>Comfort Zone Map — Seated Plane (0.6 m) · ISO 7730</h2>
        <p><span style="color:#22c55e;font-weight:700">●</span> Comfortable (|PMV| ≤ 0.5) &nbsp; <span style="color:#ef4444;font-weight:700">●</span> Discomfort</p>
        <figure class="zone-figure">
          <img src="${imgBase}/comfort_zone_seated.png" onerror="this.closest('.zone-section').style.display='none'" alt="Seated plane comfort zone">
          <figcaption>Top-down view · Seated height (0.6 m)</figcaption>
        </figure>
      </div>
