...
export default function WizardDesign() {
  ...
  const renderBuildingParameters = () => (
    <div className="border rounded-lg p-4">
      <div className="space-y-4">
        {/* Floor selector for multifloor mode */}
        {isMultifloor && Object.keys(floors).filter(floorName => floors[floorName]?.hasClosedContour).length > 1 && (
          <div className="space-y-2">
            ...
            <Select value={currentFloor} onValueChange={handleFloorChange}>
              ...
              <SelectContent>
                {(() => {
                  const availableFloors = Object.keys(floors).filter(floorName => floors[floorName]?.hasClosedContour);
        ...
        <div className="space-y-4">
          ...
          {!isMultifloor ? (
            // Single floor mode: only ceiling height control
            <div className="space-y-4">
              <div className="space-y-2">
            ...
            // Multifloor mode: controls for current floor only
            <div className="space-y-4">
              {(() => {
                const floorParams = floorParameters[currentFloor] || { ceilingHeight: 220, floorDeck: 35, ceilingTemperature: 20, floorTemperature: 20 };
                
                return (
                  <div className="p-3 rounded-lg border bg-blue-50 border-blue-200 ring-2 ring-blue-200">
                    <h5 className="font-medium text-sm mb-3 flex items-center gap-2">
                      {formatFloorText(currentFloor)}
                        ...
                        <div className="flex items-center gap-1">
                          <Input
                            ...
                            onChange={(e) => {
                              const value = parseInt(e.target.value);
                              if (!isNaN(value) && value >= 200 && value <= 500) {
                                updateFloorParameter(currentFloor, 'ceilingHeight', value);
                              }
                            }}
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              if (!isNaN(value) && value >= 5 && value <= 150) {
                                updateFloorParameter(currentFloor, 'floorDeck', value);
                              }
                            }}
                            className="w-16 h-8 text-xs"
                          />
                        ...
                        <div className="flex items-center gap-1">
                          <Input
                            ...
                            onChange={(e) => {
                              const value = parseFloat(e.target.value);
                              if (!isNaN(value) && value >= -50 && value <= 100) {
                                updateFloorParameter(currentFloor, 'ceilingTemperature', value);
                              }
                            }}
                            className="w-16 h-8 text-xs"
                          />
                        ...
                        <div className="flex items-center gap-1">
                          <Input
                            ...
                            onChange={(e) => {
                              const value = parseFloat(e.target.value);
                              if (!isNaN(value) && value >= -50 && value <= 100) {
                                updateFloorParameter(currentFloor, 'floorTemperature', value);
                              }
                            }}
                            className="w-16 h-8 text-xs"
                          />
