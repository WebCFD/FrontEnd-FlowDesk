...
def main():
    ...
    try:
        ...
        # U is kept as the original 3-D velocity vector so the frontend can
        # choose between full-3D arrows (PlaneProjection OFF) and in-plane
        # projected arrows (PlaneProjection ON) via the UI switch.
